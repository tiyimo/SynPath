...
def measure_hba1c(patient, environment, patient_time):
    ...
    next_environment_id_to_prob = {0: 0.9, 27: 0.1} 
...
def medication_change1(patient, environment, patient_time):
    ...
    entry = { # not the hba1c in this one
        ...
        "cost": 72.33, # regular cost of GP appointment plus average prescription
        "glucose": -1,
        "carbon": 23,
    }
    ...
    next_environment_id_to_prob = {0: 0.5, 7: 0.3, 27: 0.2} 
...
# Diabetes interaction 3: medication change 2 (triple therapy)
...
def glucose_management(patient, environment, patient_time):
    ...
    next_environment_id_to_prob = {0: 0.5, 27: 0.25, 29: 0.05} 
...
def annual_health_check(patient, environment, patient_time):
    ...
    next_environment_id_to_prob = {0: 0.5, 19: 0.3, 21: 0.1, 33: 0.1} 
